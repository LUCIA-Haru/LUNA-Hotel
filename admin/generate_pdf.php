...
require('./files/mpdf/vendor/autoload.php'); 
adminLogin();

require ('./files/a_links.php');
...
$table_data = "
    <h2 class='text-uppercase text-center'>BOOKING RECEIPT</h2>
    <div class='d-flex justify-content-center'>
        <table style='width:700px;' class='m-auto'>
            <tr>
                <td colspan='2' class='fw-bolder'>Reservation Details</td>
            </tr>
            <tr>
                <td>ReservationNo</td>
            ...
            <tr>
                <td colspan='2' class='fw-bolder pt-2'>Customer Details</td>
            </tr>
            <tr>
                <td>Full-Name</td>
            ...
            <tr>
                <td colspan='2' class='fw-bolder pt-2'>Room Type Details</td>
            </tr>
            <tr>
                <td>Room Type</td>
                <td>{$data['RTName']}</td>
            ...
            <tr>
                <td colspan='2' class='fw-bolder pt-2'>Payment Details</td>
            </tr>
            <tr>
                <td>Total Amount</td>
...
if ($data['ReservationStatus'] == 'CANCELLED') {
    ...
    $table_data .= "
            ...
            <tr>
                <td colspan='2' class='fw-bolder pt-2'>Refund Details</td>
            </tr>
            <tr>
                <td>Refund Amount</td>
    ...
    $table_data .= "
            ...
            <tr>
                <td colspan='2' class='fw-bolder pt-2'>Room Details</td>
            </tr>
            <tr>
